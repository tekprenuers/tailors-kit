            ...
            </Helmet>
            {
                (status !== "loaded") ?
                    ...
                    <>
                        ...
                        {
                            (Object.keys(cusData).length) ?
                                //record does exist
                                <>
                                    <section className="card">
                                        <header className="card-header">
                                            <h4 className="card-header-title has-text-info">Customer's profile</h4>
                                            ...
                                            <section className="card mt-3">
                                                <header className="card-header">
                                                    ...
                                                    <span className="card-header-icon">
                                                        <div className="buttons is-right">
                                                            <a title="Update this measurement" href={import.meta.env.VITE_DASHBOARD_URL + '/add-measurement/' + cus_id} className="button is-primary">
                                                                <span>
                                        ...
                                        (cusData?.requests?.length) ?
                                            <section className="card mt-3">
                                                <header className="card-header">
                                                    ...
                                                    <span className="card-header-icon">
                                                        <a href={import.meta.env.VITE_DASHBOARD_URL + '/orders/' + cus_id} className="button is-app-primary">View Orders</a>
                                                    </span>
                                                </header>
                                                <table className="table w-100 is-striped is-hoverable">
                                                    <tbody>
